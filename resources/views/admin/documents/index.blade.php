...
<div class="container mt-5">
    <div class="row">
        <div class="col-md-12">
            ...
            <!-- Button to open the modal to create a new document -->
            <button type="button" class="btn btn-primary mb-3" data-toggle="modal" data-target="#createDocumentModal">
                Create New Document
            </button>

            <form method="GET" action="{{ route('admin.documents.index') }}" class="form-inline mb-3">
                    ...
                    @foreach ($documents as $document)
                        <tr>
                            ...
                            <td>
                                ...
                                <button type="button" class="btn btn-warning btn-sm" data-toggle="modal" data-target="#editDocumentModal-{{ $document->id }}">
                                    Edit
                                </button>

                                <!-- Inline form for deleting the document -->
                        ...
                        <!-- Edit Document Modal -->
                        <div class="modal fade" id="editDocumentModal-{{ $document->id }}" tabindex="-1" role="dialog" aria-labelledby="editDocumentModalLabel-{{ $document->id }}" aria-hidden="true">
                                    ...
                                    <div class="modal-body">
                                        <form action="{{ route('admin.documents.update', $document) }}" method="POST">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="project_id" class="form-control" value="{{ $document->project->id }}">
                                            </div>
                                            <div class="form-group">
                                                <label for="client_id">Client</label>
                                                <input type="text" name="client_id" class="form-control" value="{{ $document->client->id }}">
                                            </div>
